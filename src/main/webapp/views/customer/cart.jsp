        ...
        <div class="content">
            <div class="content_top">
                <div class="heading">
                    ...
                    <c:if test="${cart == null}">
                        <h4 style="color: red; font-style: italic;margin-top: 30px">Giỏ hàng trống</h4>
                    </c:if>
                </div>
                <div class="clear"></div>
            </div>
                    ...
                    <table>
                        ...
                        <c:forEach var="cart" items="${cart}">
                            ...
                            <tr>
                                <td>${count}</td>
                                <td><img
                                        src="${pageContext.servletContext.contextPath}/footwear/images/${cart.value.product.image}"
                                        style="width: 60px"/></td>
                                ...
                                <td>
                                    <a class="btn btn-danger"
                                       href="${pageContext.request.contextPath}/cart/delete/${cart.value.product.id}">Xóa</a>
                                </td>
                            </tr>
